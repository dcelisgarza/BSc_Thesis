...
def plot2(data,xlabel,ylabel,lpos,b,xlim,ylim,name,ext):
    x, y0, y1, y2, y3 = data[:,0], data[:,1], data[:,2], data[:,3], data[:,4]
    fig, ax = plt.subplots(figsize=(12,7.42))
    ax.plot(x, y0,label=r'$ R_{1\leftarrow 2} $', ls = '-', c = 'b', lw = 2.5, 
            marker = 'o', markersize = 10)
    ax.plot(x, y1,label=r'$ R_{2\leftarrow 2} $', ls = '-.', c = 'g', lw = 2.5, 
            marker = 's', markersize = 10)
    ax.plot(x, y2,label=r'$ T_{1\leftarrow 2} $', ls = '--', c = 'r', lw = 2.5, 
            marker = 'd', markersize = 10)
    ax.plot(x, y3,label=r'$ T_{2\leftarrow 2} $', ls = '--', c = 'k', lw = 2.5, 
            dashes=[8, 4, 2, 4, 2, 4], marker = '*', markersize = 10)
    ax.grid(b=True, which='major', color='0.5',linestyle=':')
    ax.set_xlabel(xlabel)
    ax.set_ylabel(ylabel)
...
data = np.loadtxt(scp+'sc_prob_lh.dat')
...
# Initial state = 2
data = np.loadtxt(scp+'sc_prob_i2.dat')
xlabel = r'Initial Nuclear Momentum ($P_{i}$)'
ylabel = r'Probability'
lpos = (0.4, 0.65)
b = 5
...
ylim = [0,1]
name = ipt+'sc_prob_i2'
plot2(data,xlabel,ylabel,lpos,b,xlim,ylim,name,ext)

data = np.loadtxt(dcp+'dc_prob_lh.dat')
xlabel = r'$\ln{(E_{i})}$'
ylabel = r'Probability'
lpos = (0.4, 0.7)
b = 1
...
# Initial state 2
data = np.loadtxt(dcp+'dc_prob_i2.dat')
xlabel = r'$\ln{(E_{i})}$'
ylabel = r'Probability'
lpos = (0.35, 0.7)
b = 0.5
...
data = np.loadtxt(ecp+'ec_prob_lh.dat')
xlabel = r'Initial Nuclear Momentum ($P_{i}$)'
ylabel = r'Probability'
lpos = (0.35, 0.6)
b = 2
...
data = np.loadtxt(ecp+'ec_prob_i2.dat')
xlabel = r'Initial Nuclear Momentum ($P_{i}$)'
ylabel = r'Probability'
lpos = (0.55, 0.8)
b = 2
...
data = np.loadtxt(ecp+'ec_prob_lh2.dat')
lpos = (0.35, 0.6)
name = ipt+'ec_prob_lh2'
plot(data,xlabel,ylabel,lpos,b,xlim,ylim,name,ext)

data1 = np.loadtxt(ecp+'ec_prob_lh.dat')
data2 = np.loadtxt(ecp+'ec_prob_lh2.dat')
